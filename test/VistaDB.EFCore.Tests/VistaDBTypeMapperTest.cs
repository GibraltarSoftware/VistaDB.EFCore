...
{
    public class VistaDBTypeMapperTest : RelationalTypeMapperTestBase
    {
        [Fact]
        ...
        protected override ModelBuilder CreateModelBuilder() => VistaDBTestHelpers.Instance.CreateConventionBuilder();
