...
{
    public class GearsOfWarFromSqlQueryVistaDBTest : GearsOfWarFromSqlQueryTestBase<GearsOfWarQueryVistaDBFixture>
    {
        public GearsOfWarFromSqlQueryVistaDBTest(GearsOfWarQueryVistaDBFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
