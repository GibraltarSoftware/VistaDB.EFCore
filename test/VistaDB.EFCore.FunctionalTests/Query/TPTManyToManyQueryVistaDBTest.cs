...
{
    public class TPTManyToManyQueryVistaDBTest : TPTManyToManyQueryRelationalTestBase<TPTManyToManyQueryVistaDBFixture>
    {
        public TPTManyToManyQueryVistaDBTest(TPTManyToManyQueryVistaDBFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
