...
{
    public class NorthwindJoinQueryVitaDBTest : NorthwindJoinQueryRelationalTestBase<NorthwindQuerySqlServerFixture<NoopModelCustomizer>>
    {
        public NorthwindJoinQueryVitaDBTest(
