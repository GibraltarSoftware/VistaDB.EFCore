...
{
    public class TPTManyToManyNoTrackingQueryVistaDBTest : TPTManyToManyNoTrackingQueryRelationalTestBase<
        TPTManyToManyQueryVistaDBFixture>
    {
        public TPTManyToManyNoTrackingQueryVistaDBTest(TPTManyToManyQueryVistaDBFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
