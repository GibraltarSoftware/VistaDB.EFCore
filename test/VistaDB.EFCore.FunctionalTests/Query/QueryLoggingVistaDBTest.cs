...
{
    public class QueryLoggingVistaDBTest : IClassFixture<NorthwindQuerySqlServerFixture<NoopModelCustomizer>>
    {
        public QueryLoggingVistaDBTest(NorthwindQuerySqlServerFixture<NoopModelCustomizer> fixture)
        {
            Fixture = fixture;
