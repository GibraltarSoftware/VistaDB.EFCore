...
{
    public class NullSemanticsQueryVistaDBTest : NullSemanticsQueryTestBase<NullSemanticsQueryVistaDBFixture>
    {
        // ReSharper disable once UnusedParameter.Local
        public NullSemanticsQueryVistaDBTest(NullSemanticsQueryVistaDBFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
