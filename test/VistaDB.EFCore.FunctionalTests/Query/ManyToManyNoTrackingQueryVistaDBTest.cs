...
{
    public class ManyToManyNoTrackingQueryVistaDBTest
        : ManyToManyNoTrackingQueryRelationalTestBase<ManyToManyQueryVistaDBFixture>
    {
        public ManyToManyNoTrackingQueryVistaDBTest(ManyToManyQueryVistaDBFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
