...
{
    public class TPTInheritanceQueryVistaDBTest : TPTInheritanceQueryTestBase<TPTInheritanceQueryVistaDBFixture>
    {
        public TPTInheritanceQueryVistaDBTest(TPTInheritanceQueryVistaDBFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
