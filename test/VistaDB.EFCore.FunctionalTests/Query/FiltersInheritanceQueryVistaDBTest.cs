...
{
    public class FiltersInheritanceQueryVistaDBTest : FiltersInheritanceQueryTestBase<FiltersInheritanceQueryVistaDBFixture>
    {
        public FiltersInheritanceQueryVistaDBTest(FiltersInheritanceQueryVistaDBFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
