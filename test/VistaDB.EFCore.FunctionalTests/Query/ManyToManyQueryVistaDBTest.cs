...
{
    public class ManyToManyQueryVistaDBTest : ManyToManyQueryRelationalTestBase<ManyToManyQueryVistaDBFixture>
    {
        public ManyToManyQueryVistaDBTest(ManyToManyQueryVistaDBFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
